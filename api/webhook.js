...
const buildCustomerEmailHtml = (name, amount, whatsapp) => `
  <div dir="rtl" style="font-family: Arial, sans-serif; line-height: 1.6;">
    <div style="text-align: center; margin-bottom: 20px;">
      <img src="https://ncase.sa/image/Web_Logo_-_NCASE_-_Tagline-removebg-preview.png" alt="NCASE Logo" style="max-width: 200px;" />
    </div>
    <h3>مرحباً ${name}،</h3>
    ...
    <div style="text-align: center; font-size: 14px; color: #666;">
      ...
      <p style="margin: 5px 0;">
        🌐 <a href="https://ncase.sa" style="color: #7C3097; text-decoration: none;">ncase.sa</a> | 
